      ...
      <main className="relative z-10 flex w-full flex-1 flex-col items-center justify-center px-4 py-10 sm:py-16 md:py-24">
        <div className="flex w-full max-w-[448px] flex-col gap-8">
          ...
          >
            ...
            />
            <CardHeader
              className="animate-auth-field gap-3 px-6 pb-0 pt-0 text-center sm:px-10"
            ...
            >
              ...
              <p className="text-center text-sm leading-relaxed text-brand-muted">
                Enter the email tied to your account. We’ll send a secure link
            ...
            <CardContent className="flex flex-col gap-8 px-6 sm:px-10">
              <form className="flex flex-col gap-8" onSubmit={handleSubmit}>
                ...
                <p
                  className="animate-auth-field text-center"
                  style={{ animationDelay: "240ms" }}
                >
                  <a
                    href="/"
                    className="auth-footer-text text-[10px] text-brand-muted underline-offset-4 transition-colors duration-200 hover:text-brand-text"
                  >
                    Back to sign in
                  </a>
                </p>
